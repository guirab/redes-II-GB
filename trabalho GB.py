...
#         print(f"Transmissor {self.id} esperando por {espera} unidades de tempo")
...
#             else:
#                 print(f"Transmissor {self.id} transmitindo com sucesso")
#                 break
...
# transmissor1.transmitir()
# transmissor2.transmitir()
# transmissor3.transmitir()
